        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {interests.map((interest, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className={`bg-gradient-to-br ${interest.gradient} text-center transform hover:scale-105 hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-2xl border-0 h-full group`}>
                <CardContent className="p-8">
                  <div className={`${interest.iconBg} w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300`}>
                    <interest.icon className="w-8 h-8 text-white group-hover:animate-pulse" />
                  </div>
